...
public class RTreeInnerNode extends RTreeNode  implements Serializable
{
	...
	public RPushup insert(Object key, Ref recordReference, RTreeInnerNode parent, int ptr)
	{
		...
		RPushup pushUp = children[index].insert(key, recordReference, this, index);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public RTreeInnerNode split(RPushup pushup) 
	{
	 ...
	 */
	private void insertAt(int index, Object key) 
	{
	 ...
	 */
	public void insertLeftAt(int index, Object key, RTreeNode leftChild) 
	{
		insertAt(index, key);
	 ...
	 */
	public void insertRightAt(int index, Object key, RTreeNode rightChild)
	{
		insertAt(index, key);
	 ...
	 */
	public void merge(Object parentKey, RTreeInnerNode foreignNode)
	{
