...
public abstract class RTreeNode implements Serializable{
	 ...
	 */
	public abstract RPushup insert(Object key, Ref recordReference, RTreeInnerNode parent, int ptr);
	 ...
	 */
	public abstract boolean delete(Object key, RTreeInnerNode parent, int ptr);
public abstract RTreeLeafNode searchGreaterThan(Object key);	
	/**
